...
\begin{itemize}
    ...
    \item La transferencia de aprendizaje con ResNet-50 es significativamente superior (72.00\% exactitud y 0.8358 AUC-ROC) al entrenamiento desde cero de arquitecturas convolucionales simples, requiriendo además menor número de épocas de optimización.
