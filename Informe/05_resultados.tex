...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \caption{Curvas de convergencia de pérdida.}
        \label{fig:loss_sub}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Imagenes/comparacion_metricas.png}
        \caption{Comparación comparativa de métricas en validación.}
        \label{fig:metrics_sub}
    \end{subfigure}
    \caption{Comparación cuantitativa global de los tres experimentos entrenados.}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Imagenes/matriz_confusion_scratch.png}
        \caption{Custom CNN (FL)}
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        ...
        \caption{ResNet-50 (FL)}
        \label{fig:cm_resnet_fl}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Imagenes/matriz_confusion_bce.png}
        \caption{ResNet-50 (BCE)}
        \label{fig:cm_resnet_bce}
    \end{subfigure}
    \caption{Matrices de confusión comparadas para los tres experimentos evaluados.}
    \label{fig:matrices_confusion_todas}
\end{figure}
